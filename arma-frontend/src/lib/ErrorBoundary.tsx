...
// TODO: Set up Arma Battles error reporting endpoint
const ERROR_URL = ""; // Disabled until error reporting endpoint is configured

export function reportError(error: Error, section: string) {
    // Only report if error reporting URL is configured
    if (!ERROR_URL) return;
    ...
    if (error) {
        return (
            <CrashContainer>
                ...
                <br />
                <br />
                <div>Arma Battles Chat has crashed. Here's the error:</div>
                <pre>
