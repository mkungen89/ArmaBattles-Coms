    ...
    return (
        <div style={{ marginTop: "10px" }}>
            ...
            <Checkbox
                ...
                onChange={async (v) => {
                    try {
                        ...
                        // Re-fetch the actual value to confirm the change was applied
                        await fetchValue();
                    } catch (err) {
                        console.error("Failed to update auto-start setting:", err);
                        // Revert to actual system value on error
                        await fetchValue();
                    }
                }}
                title="Start with computer"
                description="Launch Arma Battles when you log into your computer."
            />
            ...
            <Checkbox
                ...
                description="Instead of closing, Arma Battles will hide in your tray."
            />
            <Checkbox
                ...
                description="Rep Arma Battles on your Discord status."
            />
            {/* <Checkbox
            ...
            <Checkbox
                ...
                description="Let Arma Battles use its own window frame."
            />
